...
import { BookmarkButton, BookmarkCounter } from '../BookmarkButton';
import { MobileNavigation } from '../MobileNavigation';
import { OptimizedNewsCard } from '../OptimizedComponents';
...
type AdvancedSearchProps = { onSearch: (query: string) => void; articles?: { title: string }[] };
const AdvancedSearchBar: React.FC<AdvancedSearchProps> = ({ onSearch, articles = [] }) => {
...
{loading ? (
              ...
              <AdminContentLoader limit={8} showBreaking={true}>
                {({ news, breakingNews, loading, isConnected }: { news: any[]; breakingNews: any[]; loading: boolean; isConnected: boolean }) => (
