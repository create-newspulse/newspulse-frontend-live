        ...
        <div className="min-w-0 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-baseline gap-2 min-w-0">
              <div className="font-extrabold text-slate-900 dark:text-slate-100 truncate">{t('brand.name')}</div>
              <div className="text-xs text-slate-500 dark:text-slate-400 truncate">{t('brand.tagline')}</div>
            </div>
