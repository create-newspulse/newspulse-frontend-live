...
export default function SpotlightFallback728() {
  return (
        ...
        <div className="min-w-0 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-baseline gap-2 min-w-0">
              <div className="font-extrabold text-slate-900 dark:text-slate-100 truncate">News Pulse</div>
              <div className="text-xs text-slate-500 dark:text-slate-400 truncate">Your Pulse on the World&apos;s Latest News</div>
            </div>

            <div className="text-[12px] text-slate-600 dark:text-slate-300 truncate">
              Breaking • Regional • National • International • Business • Tech
            </div>
          </div>
        </div>
