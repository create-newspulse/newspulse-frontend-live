...
import { AlertTriangle, Camera, CheckCircle2, FileCheck, MapPinned, Megaphone, ShieldCheck, Users } from 'lucide-react';
...
const workflowSteps = [
  'Submission received',
  'Editorial and safety review',
  'Verification if required',
  'Request for more information if needed',
  'Approve, hold, reject, or treat as a news tip',
  'Editorial preparation if selected',
  'Possible publication',
] as const;

export default function CommunityReporterGuidelinesPage() {
  return (
    <PublicBusinessPageLayout
      title="News Pulse Community Reporter Guide"
      description="Learn how the News Pulse Community Reporter program works, who can participate, what may be submitted, and the editorial, safety and responsibility standards that apply."
    ...
    >
      <section className="grid items-start gap-6 lg:grid-cols-[minmax(0,1.08fr)_minmax(300px,0.92fr)]">
        <SurfacePanel className="min-w-0 overflow-hidden sm:p-10">
          <PageEyebrow tone="slate">Community Reporter Guide</PageEyebrow>
          <h1 className="mt-5 max-w-3xl break-words text-4xl font-black tracking-tight text-slate-950 sm:text-[3.1rem] sm:leading-[1.05]">
            News Pulse Community Reporter Guide
          </h1>
          <p className="mt-5 max-w-3xl text-base leading-8 text-slate-600 sm:text-[17px]">
            Learn how the Community Reporter program works, who can participate, what may be submitted, how submissions are verified, and the standards that apply before anything is published.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            <Link href="/community-reporter" className="inline-flex items-center rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">
              Submit Your Story
            </Link>
        ...
        <SurfacePanel className="min-w-0 bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(30,41,59,0.98))] text-white">
          ...
          <div className="mt-6 space-y-3 text-sm leading-7 text-white/74">
            ...
            <div className="rounded-[22px] border border-white/10 bg-white/5 px-4 py-4">Community Reporter participation does not provide a News Pulse press card, media accreditation, special access, authority to enter restricted areas, or permission to represent News Pulse.</div>
          </div>
        </SurfacePanel>
      </section>
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-2">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="What Is Community Reporter?" kicker="A" />
        ...
        <SurfacePanel className="min-w-0">
          <SectionHeading title="Who Can Participate?" kicker="B" />
          <p className="mt-5 text-sm leading-7 text-slate-600">
            Readers, citizens, students, local contributors and other members of the public may submit information. You do not need to be a professional journalist to submit a responsible community report.
          </p>
        </SurfacePanel>
      </section>
      ...
      <section className="mt-8">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="Community Reporter vs Professional Journalist" kicker="C" />
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <div className="rounded-[22px] border border-slate-200 bg-white px-4 py-4 text-sm leading-7 text-slate-600">
              <strong className="text-slate-950">Community Reporter</strong> means a contributor or public participant who shares information for editorial review. Participation does not automatically make someone a News Pulse journalist.
            </div>
            <div className="rounded-[22px] border border-slate-200 bg-white px-4 py-4 text-sm leading-7 text-slate-600">
              <strong className="text-slate-950">Professional Journalist / Media Person</strong> status may require separate verification. Formal journalist workflows belong to the <Link href="/journalist-desk" className="font-semibold text-sky-700 underline">Journalist Desk</Link>.
            </div>
          </div>
        </SurfacePanel>
      </section>
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="What You Can Submit" kicker="D" />
          <p className="mt-5 text-sm leading-7 text-slate-600">
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-2">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="Safety & Verification" kicker="E" />
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
            <p>Do not put yourself or others at risk. Do not enter restricted areas, interfere with emergency services, or break any law while gathering information.</p>
            <p>News Pulse may verify details before deciding whether a submission can be used, edited, held, rejected, or treated only as a news tip.</p>
          </div>
        </SurfacePanel>

        <SurfacePanel className="min-w-0">
          <SectionHeading title="Verification Before Publication" kicker="G" />
          <p className="mt-5 text-sm leading-7 text-slate-600">
      ...
      <section className="mt-8">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="What Is Not Allowed" kicker="H" />
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-2">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="Responsibility of the Submitter" kicker="I" />
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
        ...
        <SurfacePanel className="min-w-0">
          <SectionHeading title="Privacy / Photos / Videos / Copyright" kicker="J" />
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
            <p>Submit only photos, videos, text, or documents you created or have lawful permission to share. Copyright rules still apply.</p>
            <p>Do not expose sensitive personal information unnecessarily. News Pulse may crop, blur, edit, hold, reject, or remove material for editorial, safety, copyright, or privacy reasons.</p>
          </div>
        </SurfacePanel>
      </section>
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-2">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="No Official Representation" kicker="K" />
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
            ...
            <p>Community Reporter participation does not provide a News Pulse press card, media accreditation, special access, authority to enter restricted areas, or permission to represent News Pulse.</p>
          </div>
        </SurfacePanel>

        <SurfacePanel className="min-w-0">
          <SectionHeading title="What Happens After Submission?" kicker="L" />
          <ol className="mt-5 space-y-3 text-sm leading-7 text-slate-600">
            {workflowSteps.map((step) => (
              <li key={step} className="rounded-[22px] border border-slate-200/80 bg-white px-4 py-3 shadow-[0_12px_28px_-24px_rgba(15,23,42,0.22)]">{step}</li>
            ))}
          </ol>
          <p className="mt-5 text-sm leading-7 text-slate-600">Submission does not guarantee publication. Reporter Portal users may track available status updates through My Submissions.</p>
        </SurfacePanel>
      </section>

      <section className="mt-8 grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
        <SurfacePanel className="min-w-0 bg-slate-50/90">
          <SectionHeading title="News Pulse Rules" kicker="M" />
          <div className="mt-5 rounded-[24px] border border-slate-200/80 bg-slate-50/90 p-5 shadow-[0_16px_36px_-30px_rgba(15,23,42,0.24)]">
            <ul className="space-y-3 text-sm leading-7 text-slate-600">
              <li>Nothing is auto-published.</li>
              <li>Submission does not guarantee publication.</li>
              <li>News Pulse may verify, edit, hold, reject, or remove submissions.</li>
              <li>Community submission does not make the submitter a News Pulse employee, journalist, representative, agent, or authorised spokesperson.</li>
              <li>Users must not put themselves or others at risk while gathering information.</li>
            </ul>
          </div>
        </SurfacePanel>

        <SurfacePanel className="min-w-0 overflow-hidden bg-[linear-gradient(180deg,rgba(248,250,252,0.96),rgba(255,255,255,0.99))]">
          <SectionHeading title="Editorial Review" kicker="N" />
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/editorial-policy" className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
              Editorial Policy
            </Link>
      ...
      <section className="mt-8 grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
        <SurfacePanel className="min-w-0">
          <SectionHeading title="How to Submit" kicker="O" />
          <p className="mt-5 text-sm leading-7 text-slate-600">Keep these details ready before using the online Community Reporter form:</p>
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <SurfacePanel className="min-w-0">
          ...
          <div className="mt-4 text-lg font-black tracking-tight text-slate-950">Ready to submit?</div>
          <p className="mt-2 text-sm leading-7 text-slate-600">
            Share local issues, civic updates, positive stories, and public-interest information with News Pulse through the operational submission page.
          </p>
          <Link href="/community-reporter" className="mt-6 inline-flex items-center justify-center rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">
            Submit Your Story
          </Link>
        </SurfacePanel>
      </section>
